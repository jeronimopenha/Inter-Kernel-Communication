...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("out_r_TSTRB", 4, hls_out, 5, "axis", "out_data", 1),
	Port_Property("out_r_TLAST", 1, hls_out, 6, "axis", "out_data", 1),
...
const char* HLS_Design_Meta::dut_name = "krnl_stream_vadd";
