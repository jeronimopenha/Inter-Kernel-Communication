...
HD_PWD='/home/centos/workspace/Pipe_kernels/Emulation-HW/build/krnl_stream_vmult/krnl_stream_vmult'
cd "$HD_PWD"
...
EAStep vitis_hls -f krnl_stream_vmult.tcl -messageDb vitis_hls.pb
