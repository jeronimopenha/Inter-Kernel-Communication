...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("in2_TDATA", 32, hls_in, 2, "axis", "in_data", 1),
	Port_Property("in2_TVALID", 1, hls_in, 5, "axis", "in_vld", 1),
	Port_Property("in2_TREADY", 1, hls_out, 5, "axis", "in_acc", 1),
	Port_Property("in2_TKEEP", 4, hls_in, 3, "axis", "in_data", 1),
	Port_Property("in2_TSTRB", 4, hls_in, 4, "axis", "in_data", 1),
	Port_Property("in2_TLAST", 1, hls_in, 5, "axis", "in_data", 1),
...
const char* HLS_Design_Meta::dut_name = "krnl_stream_vmult";
