...
HD_PWD='/home/centos/workspace/Pipe_kernels/Emulation-SW/build/krnl_stream_vadd/krnl_stream_vadd'
cd "$HD_PWD"
...
EAStep vitis_hls -f krnl_stream_vadd.tcl -messageDb vitis_hls.pb
